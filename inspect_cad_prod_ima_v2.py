...
def run():
    try:
        ...
        cur.execute(f"SELECT for_codigo, for_nome FROM {schema}.fornecedores WHERE for_nome ILIKE '%IMA%'")
        ...
        ima_id = fornecedores[0][0] # Assuming first match is correct, usually IMA is unique enough or I'll pick first
