...
const FinancialSuppliersPage = () => {
    ...
    const handleDelete = async (supplier) => {
        if (window.confirm(`Deseja realmente excluir o fornecedor ${supplier.nome_razao}?`)) {
            try {
                const url = getApiUrl(NODE_API_URL, `/api/financeiro/fornecedores/${supplier.id}`);
    ...
    return (
        <div className="h-full bg-slate-50 p-6">
            <GridCadPadrao
                title="Fornecedores Financeiros"
                subtitle="Gerencie os fornecedores para contas a pagar"
                icon={Truck}
                data={paginatedData}
                loading={loading}
                columns={columns}
            ...
            <Dialog open={openDialog} onOpenChange={setOpenDialog}>
                <DialogContent className="max-w-3xl p-0 overflow-hidden rounded-3xl border-none shadow-2xl">
                    <DialogHeader className="bg-red-600 px-8 py-6 text-white relative h-32 flex flex-col justify-center">
                        ...
                        <p className="text-red-100 text-xs font-bold uppercase tracking-widest relative z-10 mt-1 opacity-80">
                        ...
                        <Tabs defaultValue="basico" className="w-full">
                            <div className="flex justify-center mb-8">
                                <TabsList className="bg-slate-100 p-1 rounded-2xl border border-slate-200/50">
                                    <TabsTrigger value="basico" className="px-8 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest data-[state=active]:bg-white data-[state=active]:text-red-600 data-[state=active]:shadow-sm transition-all">
                                        <Info size={14} className="mr-2" /> Dados Básicos
                                    </TabsTrigger>
                                    <TabsTrigger value="endereco" className="px-8 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest data-[state=active]:bg-white data-[state=active]:text-red-600 data-[state=active]:shadow-sm transition-all">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="space-y-2">
                                        ...
                                        <div className="grid grid-cols-2 gap-2">
                                            <Button
                                                ...
                                                className={`rounded-xl h-11 font-bold ${formData.tipo_pessoa === 'F' ? 'bg-red-600 text-white' : 'text-slate-500 border-slate-200'}`}
                                            ...
                                            <Button
                                                ...
                                                className={`rounded-xl h-11 font-bold ${formData.tipo_pessoa === 'J' ? 'bg-red-600 text-white' : 'text-slate-500 border-slate-200'}`}
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="relative">
                                            <Input
                                                ...
                                                className="rounded-xl h-11 border-slate-200 focus:border-red-500 transition-all font-mono"
                                    ...
                                    <div className="col-span-full space-y-2">
                                        ...
                                        <Input
                                            ...
                                            className="rounded-xl h-11 border-slate-200 focus:border-red-500 transition-all font-bold text-slate-700"
                                    ...
                                    {formData.tipo_pessoa === 'J' && (
                                        <div className="col-span-full space-y-2">
                                            ...
                                            <Input
                                                ...
                                                className="rounded-xl h-11 border-slate-200 focus:border-red-500 transition-all"
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <Input
                                            ...
                                            maxLength={2}
                                            className="rounded-xl h-11 border-slate-200 focus:border-red-500 transition-all text-center uppercase font-black"
                                        />
                                    </div>
                                </div>
                            </TabsContent>
                    ...
                    <DialogFooter className="bg-slate-50 px-8 py-4 border-t border-slate-100 mt-4 flex items-center justify-between">
                        <div className="flex items-center gap-2">
                            ...
                            >
                                {formData.ativo ? 'FORNECEDOR ATIVO' : 'FORNECEDOR INATIVO'}
                            </Badge>
                        </div>
                        <div className="flex gap-3">
                            ...
                            <Button onClick={handleSave} className="bg-red-600 hover:bg-red-700 text-white font-black text-[10px] uppercase tracking-widest h-11 px-8 rounded-xl shadow-lg shadow-red-600/20 transition-all hover:scale-[1.02]">
