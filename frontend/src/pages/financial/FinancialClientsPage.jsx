...
const FinancialClientsPage = () => {
    ...
    const pfClients = clients.filter(c => c.tipo_pessoa === 'F').length;
    const pjClients = clients.filter(c => c.tipo_pessoa === 'J').length;
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                    ...
                    <Box>
                        ...
                        <Typography variant="body2" color="text.secondary">
                            Gerencie os clientes para contas a receber
                        </Typography>
                    </Box>
                </Box>
                <Button
                ...
                <Table>
                    ...
                    <TableBody>
                        {filteredClients.map((client) => (
                            ...
                            >
                                <TableCell sx={{ fontWeight: 600 }}>{client.nome_razao}</TableCell>
                                <TableCell>{client.cpf_cnpj}</TableCell>
                                <TableCell>
                                    <Chip
                                        label={client.tipo_pessoa === 'F' ? 'PF' : 'PJ'}
                                        color={client.tipo_pessoa === 'F' ? 'info' : 'warning'}
                                        size="small"
                                    />
                                </TableCell>
