                    ...
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-end bg-slate-50/50 dark:bg-slate-900/50 p-4 rounded-xl border border-slate-100 dark:border-slate-700 shadow-sm">
                        ...
                        <div className="col-span-12 md:col-span-2 flex items-center">
                            <button
                                onClick={loadData}
                                disabled={loading}
                                className="w-full h-10 flex items-center justify-center gap-2 px-4 bg-emerald-600 hover:bg-emerald-700 disabled:bg-slate-400 text-white font-black uppercase tracking-widest text-[11px] rounded-md shadow-lg shadow-emerald-500/20 transition-all active:scale-95"
                            >
                                {loading ? (
                    ...
                    <CardContent className="p-0 overflow-auto flex-1">
                        {loading ? (
                            ...
                            <div className="flex flex-col items-center justify-center h-full text-slate-400 bg-slate-50/50">
                                <div className="bg-slate-100 p-8 rounded-full mb-4 border border-dashed border-slate-200">
