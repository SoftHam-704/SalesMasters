...
export default function CustomOrdersPage({ forceProjetos }) {
    ...
    return (
        <div className="flex h-screen bg-[#f5f5f5] relative overflow-hidden font-body">
            ...
            <div className="fixed inset-0 pointer-events-none opacity-[0.03] z-[9999] bg-[url('data:image/svg+xml,%3Csvg viewBox=\'0 0 200 200\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cfilter id=\'noiseFilter\'%3E%3CfeTurbulence type=\'fractalNoise\' baseFrequency=\'0.65\' numOctaves=\'3\' stitchTiles=\'stitch\'/%3E%3C/filter%3E%3Crect width=\'100%25\' height=\'100%25\' filter=\'url(%23noiseFilter)\'/%3E%3C/svg%3E')]"></div>

            {/* Design System Grid Lines */}
            <div className="fixed inset-0 pointer-events-none grid grid-cols-12 gap-0 z-0 h-full w-full opacity-[0.05]">
                {[...Array(12)].map((_, i) => (
