...
async function importJson() {
    ...
    try {
        console.log('🚀 Iniciando Importação Repsoma V3 (Com ON CONFLICT)...');
        ...
        for (let i = 0; i < pedidosSet.length; i += 500) {
            ...
            // Usamos ped_pedido como critério de conflito pois é a PK de pedidos
        ...
        for (let i = 0; i < itensSet.length; i += 500) {
            ...
            // Usamos ite_lancto como critério de conflito pois é a PK (e tem index unique)
